...
class Helper {
  ...
  static Future<bool> saveUserNameInSharedPreferences(String token) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();

    return await prefs.setString(sharedPreferencesUserNameInKey, token);
  }

  static getUserNameInSharedPreferences() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static getUserLocaleInSharedPreferences() async {
    ...
    return await prefs.get(sharedPreferencesUserLocale) ?? '';
  }
  ...
  static getTerminationInSharedPreferences() async {
    ...
    return await prefs.get(sharedPreferencesTermination) ?? '-1';
  }
  ...
  static getDateInSharedPreferences() async {
    ...
    return await prefs.get(sharedPreferencesDate) ?? '';
  }
  ...
  static getIncomeInSharedPreferences() async {
    ...
    return await prefs.get(sharedPreferencesIncome) ?? '';
  }
  ...
  static getCreditInSharedPreferences() async {
    ...
    return await prefs.get(sharedPreferencesCreditJson) ?? '';
  }
}
